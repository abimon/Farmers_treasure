...
<head>
    <meta charset="utf-8">
    <title>Farmes' Treasure | {{$title}}</title>
        ...
        <div class="container topbar bg-primary d-none d-lg-block">
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-phone me-2 text-secondary"></i> <a href="#" class="text-white">+254 728 886 217</a></small>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index" class="navbar-brand">
                    <h1 class="text-primary display-6">Farmer's Treasure</h1>
                </a>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <a href="/carts" class="position-relative me-4 my-auto">
                            ...
                            <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{Auth()->user()?App\Models\POrder::where('user_id',Auth()->user()->id)->where('isDelivered',false)->count():'0'}}</span>
                        </a>
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">Farmers' Treasure</h1>
            ...
            <div class="row g-5">
                <div class="col-md-4">
                    <div class="footer-item">
                        ...
                        <p class="mb-4">To provide high-quality cereals and agricultural products to meet the demand of our customers while supporting local farmers and sustainable farming practices.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Farmers' Treasure</a>, All right reserved.</span>
                </div>
